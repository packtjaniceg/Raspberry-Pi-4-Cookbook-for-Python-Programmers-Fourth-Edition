...
THRESH_LOW = [[80, 40, 0], [40, 80, 0], [40, 0, 80], [80, 0, 80],
              [0, 80, 80]]
THRESH_HI = [[220, 100, 80], [100, 220, 80], [100, 80, 220],
             [220, 80, 220], [80, 220, 220]]
...
def process_image(raw_image,control):
    ...
    if max_area > 0:
        cv2.circle(raw_image, (cx, cy), 8,
                   (THRESH_HI[threshold]), -1)
        cv2.circle(raw_image, (cx, cy), 4,
                   (THRESH_LOW[threshold]), -1)
